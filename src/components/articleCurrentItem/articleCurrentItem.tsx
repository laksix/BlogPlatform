...
const ArticleCurrentItem = () => {
    ...
    /> : null}
            ...
            <div className={clasess.slugInfo}>
                ...
                {!favorited ? <div onClick={() => 
                dispatch(LikeCurrentArticle(currentSlug,token)
                )}
                 className={clasess.slugLikes}><img src={imgUnLike} className={clasess.imgLikes}/>
                 <div className={clasess['slugLikes-count']}>{favoritesCount}</div></div> 
                 
                 : 
                 
                 <div onClick={() => 
                 dispatch(UnLikeCurrentArticle(currentSlug,token))} 
