    ...
    return (
        <div className={clasess.title}>
            ...
            <div className={clasess.isAuth}>
                ...
                <div onClick={() => dispatch(UserSlice.actions.userLogout())} className={clasess.logout}>Log Out</div>
            </div> : 
            
            <div className={clasess.auth}>
                <div className={clasess.authOff}><Link className={clasess.authIn} to= '/sign-in'>Sign In</Link></div>
                <Link to = '/sign-up' className={clasess['title-signUp']}> <div className={clasess.authOn}>Sign Up </div></Link>
            </div>}
        </div>
    )
}
