  ...
  const dispatch = useAppDispatch()
    ...
    /> : null}
         ...
         <div className={clasess.title}>Edit Profile</div>
          <div className={clasess['mainBox-inputs']}>
           ...
           <div className={clasess.currentInput}>
            ...
            <input className={clasess.inputSet} defaultValue={defaultUserInfo.username} placeholder="Username"
        {...register("username", {
          required: true,
          minLength: 3,
          maxLength: 20,
      ...
      <div className={clasess.currentInput}>
            ...
            <input className={clasess.inputSet} defaultValue={defaultUserInfo.email} placeholder="Email address" type="email"
        {...register("email", {
          required: true,
      ...
      <div className={clasess.currentInput}>
            ...
            <input className={clasess.inputSet} placeholder="New password" type="password"
        {...register("password", {
          required: true,
          maxLength:40,
          minLength:6,
      ...
      <div className={clasess.currentInput}>
            ...
            <input className={clasess.inputSet} defaultValue={defaultUserInfo.image} placeholder="Avatar image" type="avatar"
        {...register("url", {
          required: true,
      ...
      {errors?.url?.type === "pattern" && (
        <p className={clasess.inputError}>Введите корректную ссылку</p>
      )}
