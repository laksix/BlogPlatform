  ...
  const currentSlug = useAppSelector(state => state.Aritcles.currentSlug)
    ...
    return (
         ...
         <div className={clasess.title}>Edit the article</div>
          <div className={clasess['mainBox-inputs']}>
           ...
           <div className={clasess.currentInput}>
            ...
            <input defaultValue={prevArticle.title} className={clasess.inputSetCreate} placeholder="Title"
      ...
      <div className={clasess.currentInput}>
            ...
            <input defaultValue={prevArticle.description} className={clasess.inputSetCreate} placeholder="Title" type="text"
        {...register("decriptionOfAritcle", {
          required: true,
          pattern: /^([A-Za-z]|[0-9])|([0-9]|[A-Za-z])+$/i
        })}
      />
      {errors?.decriptionOfAritcle?.type === "required" && <p className={clasess.inputError}>Заполните поле</p>}
      ...
      <div className={clasess.currentInput}>
            ...
            <textarea defaultValue={prevArticle.body} className={clasess.inputSetCreateText} placeholder="Text" 
      ...
      <div className={clasess.tags}> Tags
      <>
      ...
      <div className={clasess.addTag} onClick={handleAdd}>Add tag</div>
      </div>
